  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'text' || field.tagName.toLowerCase() === 'textarea') && isRequired) {
          if (value.length < 2) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const fields = contactForm.querySelectorAll('input:not([type="hidden"]):not([type="submit"]):not([type="reset"]):not([type="checkbox"]):not([type="radio"]), textarea, select');
      ...
      successMsg.style.cssText = 'padding:1rem;background:#c6f6d5;color:#276749;border-radius:0.375rem;margin-top:1rem;text-align:center;';

      setTimeout(function () {
        contactForm.reset();
        contactForm.querySelectorAll('.field-valid').forEach(function (f) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'edec4b13-df45-4d40-bf0c-452d131b5045',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'edec4b13-df45-4d40-bf0c-452d131b5045';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'edec4b13-df45-4d40-bf0c-452d131b5045';
